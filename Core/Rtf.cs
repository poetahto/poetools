...
namespace poetools.Core
{
    ...
    public static class RichTextFormatExtensions
    {
        ...
        public static IRichTextData Rtf(this Color color)
        {
            ...
            return global::poetools.Core.Rtf.Color(hexColor);
        }
        ...
        {
            return message.Format(global::poetools.Core.Rtf.Bold);
        }
        
        public static string Italic(this string message)
        {
            return message.Format(global::poetools.Core.Rtf.Italic);
        }
        ...
        {
            return message.Format(global::poetools.Core.Rtf.Size(size));
        }
        
        public static string Material(this string message, ushort id)
        {
            return message.Format(global::poetools.Core.Rtf.Material(id));
        }

        #region Colors

        public static string Aqua(this string message)      { return message.Format(global::poetools.Core.Rtf.AquaColor); }
        public static string Black(this string message)     { return message.Format(global::poetools.Core.Rtf.BlackColor); }
        public static string Blue(this string message)      { return message.Format(global::poetools.Core.Rtf.BlueColor); }
        public static string Brown(this string message)     { return message.Format(global::poetools.Core.Rtf.BrownColor); }
        public static string Cyan(this string message)      { return message.Format(global::poetools.Core.Rtf.CyanColor); }
        public static string DarkBlue(this string message)  { return message.Format(global::poetools.Core.Rtf.DarkBlueColor); }
        public static string Fuchsia(this string message)   { return message.Format(global::poetools.Core.Rtf.FuchsiaColor); }
        public static string Green(this string message)     { return message.Format(global::poetools.Core.Rtf.GreenColor); }
        public static string Grey(this string message)      { return message.Format(global::poetools.Core.Rtf.GreyColor); }
        public static string LightBlue(this string message) { return message.Format(global::poetools.Core.Rtf.LightBlueColor); }
        public static string Lime(this string message)      { return message.Format(global::poetools.Core.Rtf.LimeColor); }
        public static string Magenta(this string message)   { return message.Format(global::poetools.Core.Rtf.MagentaColor); }
        public static string Maroon(this string message)    { return message.Format(global::poetools.Core.Rtf.MaroonColor); }
        public static string Navy(this string message)      { return message.Format(global::poetools.Core.Rtf.NavyColor); }
        public static string Olive(this string message)     { return message.Format(global::poetools.Core.Rtf.OliveColor); }
        public static string Orange(this string message)    { return message.Format(global::poetools.Core.Rtf.OrangeColor); }
        public static string Purple(this string message)    { return message.Format(global::poetools.Core.Rtf.PurpleColor); }
        public static string Red(this string message)       { return message.Format(global::poetools.Core.Rtf.RedColor); }
        public static string Silver(this string message)    { return message.Format(global::poetools.Core.Rtf.SilverColor); }
        public static string Teal(this string message)      { return message.Format(global::poetools.Core.Rtf.TealColor); }
        public static string White(this string message)     { return message.Format(global::poetools.Core.Rtf.WhiteColor); }
        public static string Yellow(this string message)    { return message.Format(global::poetools.Core.Rtf.YellowColor); }
